...
public partial class Oracle_ControlLibrary_ucRDShell : System.Web.UI.UserControl
{
    long patientKey;
    ...
    private void LoadDataForSpecifiedRDName(string RDName)
    {
        ...
        if (rowIndex > -1)
        {
            ...
            if (disType.Equals("D"))                //typeof(RD) == Diagnostics
            {
                ...
                string path = ("~/Oracle/ControlLibrary/ucRDDiagnosisMain.ascx"); //ucRDDiagnosisMain.ascx
