<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoctorAlertNetwork.aspx.cs" Inherits="Oracle_DoctorAlertNetwork" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Doctor Alert Network </title>
        ...
        <tr>
            <td align="left" valign="top">
                <div id="dvVitalSigns" style="padding: 10px;">
                    ...
                    <%--<h2>Vital Signs</h2>--%>
                    <div>
                        <span class="caption">Physician</span>
                        <asp:Label ID="lblPhysicianName" runat="server" ></asp:Label>
                    </div>
                    <br />
                    <div>
                        <span class="caption">Subjective</span>
                        <asp:TextBox ID="txtSubjective" runat="server" Height="50px" TextMode="MultiLine"
                            Width="300px"></asp:TextBox>
                    </div>
                    <br />
                    <div>
                        <span class="caption">Objective</span>
                        <asp:TextBox ID="txtObjective" runat="server" Height="50px" TextMode="MultiLine"
                            Width="300px"></asp:TextBox>
                    </div>
                    <br />
                    <h2>Vital Signs</h2>
                    <div>
                        ...
                        <div>
                            ...
                            <asp:RadioButtonList ID="rblPlan" runat="server" >
