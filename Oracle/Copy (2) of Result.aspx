<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copy (2) of Result.aspx.cs" Inherits="SecuredPages_Result" %>
...
<%@ Register Src="~/Oracle/ControlLibrary/ucCommentsTop.ascx" TagName="CommentsAtTop" TagPrefix="uc" %>
<%@ Register Src="~/Oracle/ControlLibrary/ucDisclaimer.ascx" TagName="Disclaimer" TagPrefix="uc" %>
...
<body style="margin: 0">
    <form id="form1" runat="server">
            ...
            <tr valign="top">
                <td id="offsetElement" style="height: 100%; width: 25%" valign="top">
                    ...
                    <cc1:RadDockingZone ID="ZoneQL" runat="server" BackColor="Transparent" Height="100%"
                        ...
                        <cc1:RadDockableObject ID="RadDockableObject2" runat="server" AllowedDockingZoneTypes="Custom"
                            AllowedDockingZones="ZoneQL" Behavior="Pin" DockingMode="AlwaysDock" Text="Quick Links"
                            Width="100%">
                            <ContentTemplate>
                ...
                <td style="height: 100%; width: 75%">
                    <cc1:RadDockingZone ID="ZoneRDQL" runat="server" BackColor="Transparent" Height="100%"
                        Type="Horizontal" Width="100%">
                        <cc1:RadDockableObject ID="RadDockableObject1" runat="server" AllowedDockingZoneTypes="Custom"
                            AllowedDockingZones="ZoneRDQL" Behavior="Pin" DockingMode="AlwaysDock" Text="Remarkable Discipline(s)"
                            Width="100%">
                            <ContentTemplate>
        ...
        <radA:AjaxLoadingPanel ID="AjaxLoadingPanel" runat="server" Width="100%" Transparency="25" MinDisplayTime="1000">
            ...
            <asp:Label ID="msgPref" runat="server" Font-Names="Verdana, Arial, Tahoma" Font-Bold="true" Font-Size="10pt" ForeColor="red">Saving...</asp:Label>
        </radA:AjaxLoadingPanel>
        <radW:RadWindowManager ID="RadWindowManager1" runat="server" Height="300px" Width="600px"
            Skin="Office2007"  ShowContentDuringLoad="true"  Modal="True" UseEmbeddedScripts="false"
            Top="20" Left="30">
