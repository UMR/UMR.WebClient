...
public partial class Oracle_InstitutionProvidersCodes : System.Web.UI.Page
{
    ...
    public string dateFilter
    {
        get
        {
            if (ViewState["DATEFILTER"] != null)
                return ViewState["DATEFILTER"].ToString();
            else return null;
        }
        set
        {
            ViewState["DATEFILTER"] = value;
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            GridView1.DataSource = PatientManager.GetInstitutionCodeDateHistory(institutionCode, patientKey);
            GridView1.DataBind();
        }
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Select")
        {
            ...
            //Now get the details
            dateFilter = " AND DateOfService='" + DateTime.Parse(codedate).ToString("MM-dd-yyyy") + "'";
            RadGridMPI.DataBind();
    ...
    {
        DataTable dt = PatientManager.GetInstitutionCodeDateHistory(institutionCode, patientKey);
    ...
    protected void RadGridMPI_NeedDataSource(object source, Telerik.WebControls.GridNeedDataSourceEventArgs e)
    {
        ...
        dvwMPIInfo.RowFilter = "InstituteCode='" + institutionCode + "' " + dateFilter;
        RadGridMPI.MasterTableView.DataSource = dvwMPIInfo.ToTable();
    }
    protected void RadGridMPI_ItemDataBound(object sender, Telerik.WebControls.GridItemEventArgs e)
    {
