<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LRAEmail.aspx.cs" Inherits="Oracle_LRAEmail" %>
...
<head runat="server">
 <meta http-equiv="X-UA-Compatible" content="IE=7" />
    <title>Email Last Access Records</title>
        ...
        <div>
            <div id="displayDiv">
                ...
                <asp:RadioButtonList ID="rdbListPrintChoice" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rdbListPrintChoice_SelectedIndexChanged"
                    ...
                    <asp:ListItem Selected="True">Email all </asp:ListItem>
                    <asp:ListItem>Email range</asp:ListItem>
